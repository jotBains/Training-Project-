...
if ($errors == 0) {
    try {
        ...
        $sql = "INSERT INTO $TableName (trainingCode, studentID, date_selected) VALUES ($trainingCode, $studentID, '$DatabaseDate')";
        
        $qRes = mysqli_query($conn, $sql) ;
		$Body .= "<p>Your request for opportunity # " . " $trainingCode has been entered on $DisplayDate.</p>\n";
        mysqli_close($conn);
    }
